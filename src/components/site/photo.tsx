 ...
 * different websites, so each one carries a veil and a faint duotone wash. The
...
const WASH = {
  none: "",
  warm: "rgb(200 169 106 / 0.14)",
  cold: "rgb(74 143 231 / 0.16)",
} as const;
    ...
    <figure className={`relative overflow-hidden bg-s1 ${className}`}>
      ...
      {veil && (
        <span
          ...
          style={{ background: "linear-gradient(180deg, transparent, rgb(5 6 7 / 0.72))" }}
        />
      )}
    </figure>
  );
