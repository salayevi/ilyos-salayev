...
function Submit() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="mt-6 flex h-12 w-full items-center justify-center rounded-lg bg-gold text-[15px] font-medium text-void transition-colors hover:bg-gold-300 disabled:bg-s3 disabled:text-td"
    >
...
export function LoginForm() {
  ...
  const input =
    "mt-2 h-12 w-full rounded-lg border border-line-2 bg-s2 px-4 text-[15px] text-tp placeholder:text-tt focus:border-gold focus:outline-none";
